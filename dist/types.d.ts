export declare enum CLIENT_STATE {
    CONNECTED = "connected",
    CONNECTING = "connecting",
    DISCONNECTED = "disconnected"
}
export declare enum CONNECT_EVENT {
    CONNECT = "connect",
...
export declare enum BIZ_EVENT {
    AUTH = "auth",
    SUBSCRIBE = "subscribe"
}
export declare enum AUTH_CODE {
    AUTH_SUCCESS = "auth_success",
    AUTH_FAILED = "auth_fail"
}
export declare enum SUBSCRIBE_CODE {
